 ...
 */
export function listFilesAndDirectories(dirPath: string): DirectoryContents {
 ...
 *
 * @param {string} dirPath - The path to the directory.
 * @returns {string[]} - A list of .docx file paths.
 */
export function listDocxFiles(dirPath: string): string[] {
